...
const PAGES = [
  ...
  { path: '/work/laxmi-agro-crm', priority: '0.8', h1: 'Smart Agro CRM',
    title: `Smart Agro CRM — Laxmi Agro Business CRM Case Study | ${SITE}`,
    description: 'A complete business CRM for an agri-trading company — leads, orders, inventory and dispatch in one place.' },
